...
[![Build Status](https://travis-ci.org/Babkock/Tinyserve.svg?branch=master)](https://travis-ci.org/Babkock/Tinyserve) [![dependency status](https://deps.rs/repo/github/Babkock/tinyserve/status.svg)](https://deps.rs/repo/github/Babkock/tinyserve)
